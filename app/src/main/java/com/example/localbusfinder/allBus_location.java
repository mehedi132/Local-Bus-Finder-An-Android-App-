...
public class allBus_location extends FragmentActivity implements OnMapReadyCallback {
        ...
        public void onLocationResult(LocationResult locationResult) {
            ...
            for(Location location :locationResult.getLocations()){
                ...
                Helper helper = new Helper(location.getLatitude(),
                        location.getLongitude(),b,1);
                FirebaseDatabase.getInstance().getReference(b)
                        .setValue(helper).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful()){
                            Toast.makeText(allBus_location.this,"Location Saved",Toast.LENGTH_SHORT).show();
                        }else {
                            Toast.makeText(allBus_location.this,"Location not saved",Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_all_bus_location);
        ...
        locationSettingsResponseTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception e) {
                if(e instanceof ResolvableApiException){
                    ...
                    try {
                        apiException.startResolutionForResult(allBus_location.this,1001);
